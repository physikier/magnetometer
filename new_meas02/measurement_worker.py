...
class MeasurementWorker(object):
    ...
    def __init__(self, config=None, nidaq=None, tektronix=None, hameg=None, logger=None):
...
#         return np.arange(config['start'], config['stop'], config['step'])
    ...
    def _base_config_tektronix(self, output):
        ...
        #self._tektronix.trig_source('EXT', ch=channel)
    ...
    def _configure_lockin(self, output):
        #todo
        pass
