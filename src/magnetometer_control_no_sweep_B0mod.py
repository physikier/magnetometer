...
cell='4'
measno='19'
measurement='B0square_rb85_42.1degC_less_than_15uW_40dB' 		#number and special features of the measurement
...
tektronix.set_offset(offset=0, ch=1)


tektronix.set_waveform(func=b0waveform, ch=2)
tektronix.set_offset(b0offsetstart,ch=2) 
tektronix.set_freq(frequency=b0freq, ch=2)
tektronix.set_amp(b0amp, ch=2)
...
params=[(measno, measurement), ("StartFrequency(Hz)", fstart), ("StopFrequency(Hz)", fstop),
 ("FrequencySteps(Hz)", fstep), ("B0Frequency", b0freq), ("B0Amplitude(V)", b0amp),
 ("B0Waveform", b0waveform),
